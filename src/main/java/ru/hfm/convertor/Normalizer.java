...
class Normalizer {
    ...
    private final String DEFAULT_SourceFMEntity_VALUE = "E29000";
    private final Integer DEFAULT_SourceFMAccount_VALUE = 0;
    private final String DEFAULT_SourceICP_VALUE = "[ICP None]";
    private final String DEFAULT_SourceCustom1_VALUE = "[None]";
    private final String DEFAULT_SourceCustom2_VALUE = "[None]";
    private final String DEFAULT_SourceCustom3_VALUE = "[None]";
